...
//智能门锁
//作者：化作尘
//时间：2020年6月25日12:50:43
//qq邮箱：2809786963@qq.com
//csdn链接：https://blog.csdn.net/mbs520/article/details/106987758
//哔哩哔哩项目视频:https://b23.tv/bxfxvd
//哔哩哔哩项目源代码讲解：https://www.bilibili.com/video/BV1m5411b7BX
//注意事项：使用蓝牙串口发送密码时需要有以"::"结尾的效验码，比如"123456::"
***********************/
#include "sys.h"
#include "delay.h"
#include "usart.h"
...
void Massige(void)
{
	...
	Show_Str(0,26,128,12,"时间:2020-6-25",12,0);
	Show_Str(0,39,128,12,"qq:2809786963",12,0); 
	Show_Str(0,52,128,12,"CSDN：化作尘",12,0); 
	delay_ms(3000);
}
//开机信息
void starting(void)
...
/*********************************开机信息提示***********************************/
	...
	delay_ms(1000);
	OLED_Clear();
//	Show_Str(23,10,128,24,"化",24,0);			
//	delay_ms(300);
//	Show_Str(47,10,128,24,"作",24,0);			
//	delay_ms(300);
//	Show_Str(71,10,128,24,"尘",24,0);	
